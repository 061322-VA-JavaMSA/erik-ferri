...
public class ReimbursementHibernate implements ReimbursementDAO {
	...
	@Override
	public int updateReimbursement(int id, String reimbStatus, String reimbResolver) {
		...
		try(Session s = HibernateUtil.getSessionFactory().openSession();){
            ...
            String hql = "update Reimbursement set reimbStatus = :reimbStatus, reimbResolver = :reimbResolver where id = :reimbId";
            Query query = s.createQuery(hql);
            query.setParameter("reimbStatus", reimbStatus);
            query.setParameter("reimbResolver", reimbResolver);
